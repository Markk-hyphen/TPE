...
<div class="container w-50 mt-2 d-flex align-items-center flex-column">
        ...
        {if $materia->imagen}
            {if $loggedUser && $loggedUser->rol == 'admin'}
                <a href="deleteFile/{$materia->id_materia}" class="img-fluid">
                    <svg class="mt-1" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16" data-bs-toggle="tooltip" data-bs-placement="top" title="No me borres :(">
    ...
    <div class="d-flex  filters-wrapper">
        <button id="sort-comments" data-bs-toggle="tooltip" data-bs-placement="top" title="Clic to swap ordering" data-order="asc" data-col="2" type="button" class="btn btn-dark text-light mx-2">Fecha</button>
        <button id="sort-comments" data-order="asc" data-col="1" type="button" class="btn btn-info text-light mx-2">
